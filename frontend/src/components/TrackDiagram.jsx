// frontend/src/components/TrackDiagram.jsx
import { useSignals } from '../context/SignalContext';
import { signalPositions } from '../../../backend/data/signals.js';

export default function TrackDiagram() {
  const { signals, setSignal } = useSignals();

  const handleClick = (id) => {
    const currentAspect = signals[id] || 'RED';
    // Toggle: if RED -> try GREEN, if GREEN -> set RED
    const newAspect = currentAspect === 'RED' ? 'GREEN' : 'RED';
